...
class Header extends Component {
  state = {
    logo: {
      white: require("../../assets/images/logo/logo.png"),
      colored: require("../../assets/images/logo/logo-colored.png"),
    },
  ...
  render() {
    ...
    return (
      <header>
            ...
            <div className="header-main-logo">
              <div className="cnt1">
                <div className="cnt2 cnt-center">
                  <Link to="/">
                    <img className="main-logo" src={logo.white} />
                  </Link>
                </div>
              </div>
            </div>
                ...
                <div className="cnt2">
                  <ul className="main-nav">
                    {navItems.map((nav, index) => (
                      <NavLink key={"nav" + index} to={nav.link}>
                        <li>{nav.text}</li>
                      </NavLink>
                    ))}
                  </ul>
        ...
        <div id="header">
          <div className="header-fixed-parent">
            <div className="header-content">
              <div className="header-main-logo">
                <div className="cnt1">
                  <div className="cnt2 cnt-center">
                    <img className="main-logo" src={logo.colored} />
                  </div>
                </div>
              </div>
            </div>
